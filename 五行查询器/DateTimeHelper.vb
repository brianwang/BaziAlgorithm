...
Namespace Extension
    Public Module DateTimeHelper
        ...
        Public Function ComputeYearGan(time As Date) As String
            ...
            Dim Sexagenary = GetSexagenaryYear(time)

            Return TianGan(GetCelestialStem(Sexagenary) - 1) & DiZhi(GetTerrestrialBranch(Sexagenary) - 1)
        End Function
        ...
        Public Function ComputeMonthGan(time As Date) As String
            ...
            Return cMonthGanZhi_Table((GetCelestialStem(Sexagenary) - 1) Mod 5, lMonth)
        End Function
        ...
        Public Function ComputeDayGan(time As Date) As String
            ...
            Dim i As Integer = If(lMonth Mod 2 = 0, 6, 0)
        ...
        Private Function GetSexagenaryYear(time As Date) As Integer
            Return (time.Year - 4) Mod 60 + 1
        End Function

        Private Function GetCelestialStem(Sexagenary As Integer) As Integer
            Return (Sexagenary - 1) Mod 10 + 1
        End Function

        Private Function GetTerrestrialBranch(Sexagenary As Integer) As Integer
            Return (Sexagenary - 1) Mod 12 + 1
        End Function
